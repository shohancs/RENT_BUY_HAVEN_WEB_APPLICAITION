		...
		<div class="modal-dialog modal-xl">
			<div class="modal-content">
				<div class="modal-header">
					<h1 class="modal-title fs-5" id="exampleModalLabel">Full View of <span style="color: red;"><?php echo $seller_email; ?> </span></h1>
															...
															<select name="rent_prdId" class="form-select">
																...
																$query = mysqli_query($db, $sql);
																 while ( $row = mysqli_fetch_assoc($query) ) {
									                                ...
									                                $join_date    = $row['join_date'];
									                                ?>
									                                <option value="<?php echo $sub_id ?>" <?php if ($sub_id == $rent_prdId) {
									                                	echo "selected";
															...
															<select name="buy_prdId" class="form-select">
																...
																$query = mysqli_query($db, $sql);
																 while ( $row = mysqli_fetch_assoc($query) ) {
									                                ...
									                                $join_date    = $row['join_date'];
									                                ?>
									                                <option value="<?php echo $sub_id ?>" <?php if ($sub_id == $buy_prdId) {
									                                	echo "selected";
									                                } ?>> - <?php echo $subcat_name; ?></option>
									                                <?php
									                            }
																...
																<?php  
																	$rentDivSql = "SELECT * FROM transactions ORDER BY id DESC";
															  		...
															  		while ( $row = mysqli_fetch_assoc( $roleQuery ) ) {
														  				...
														  				$join_date  	= $row['join_date'];
														  				?>
									                                <option value="<?php echo $id ?>" <?php if ($id == $seller_email) {
									                                	echo "selected";
